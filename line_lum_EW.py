...
fig.text(0.005, 0.5, r'log$_{10}$(EW([OIII]+H$\beta$)/$\AA$)', va='center', rotation='vertical', fontsize=14)
fig.text(0.31, 0.5, r'log$_{10}$(EW([OIII]+H$\beta$)/$\AA$)', va='center', rotation='vertical', fontsize=14)
fig.text(0.61, 0.5, r'log$_{10}$(L([OIII]+H$\beta$)/L$_{\mathrm{FUV}})$', va='center', rotation='vertical', fontsize=14)
...
plt.savefig('line_lum_z7_8.pdf', dpi=300, bbox_inches='tight')
plt.show()
